...
*/}}
{{- define "cache-seeder.opentelemetryLoggingUrl" -}}
...
Usage: {{ include "cache-seeder.otelResourceAttributes" .resourceAttributes }}
*/}}
{{- define "cache-seeder.otelResourceAttributes" -}}
{{- $attributes := list }}
{{- range $key, $value := . }}
